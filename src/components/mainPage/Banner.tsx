  ...
  return (
    <section className="bg-main-page-background h-[500px] md:h-[600px] flex flex-col justify-center md:flex-row items-center bg-center bg-cover bg-no-repeat relative">
      <MaxWidthWrapper className="space-y-3">
        <h1 className="flex flex-col text-4xl md:text-7xl text-white font-black leading-tight mb-6">
          <span>在舊址裡，</span>
          <span>重新出發，重新生活</span>
        </h1>
        <EnquiryButton
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex pb-10 items-end space-x-3 md:whitespace-nowrap w-full justify-center px-2 md:px-0">
        <h4 className="text-white text-center text-[10px] md:text-xs md:text-medium whitespace-nowrap">
          死亡的百貨公司
        </h4>
        <div className="flex space-x-2 md:space-x-3 border-white border-b px-3 md:px-10 py-3 md:py-6 mb-1 items-center">
